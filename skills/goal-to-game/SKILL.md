---
name: goal-to-game
description: Generates polished, fully playable 3D game prototypes in Unity, three.js, or Godot, with high quality (.glb) meshes generated through the Thrixel API. Use when the user wants to make a game, build a playable prototype, or generate 3D assets.
---
...
- **Godot** → [engines/godot.md](engines/godot.md)
